...
gl_casp8.g$Tukey[[group_title]] <- tukey_df

# Sink to the txt file

path <- "/Users/emrecanciftci/betik/R_projects/lab_data_unipv/analysis/casp8.od-g.txt"
...
saveRDS(gl_casp8.g, "analysis/gl_casp8.g.rds")
cat("R data saved")
