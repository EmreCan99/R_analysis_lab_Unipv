...
gl_AIF.g$Tukey[[group_title]] <- tukey_df

# Sink to the txt file

path <- "/Users/emrecanciftci/betik/R_projects/lab_data_unipv/analysis/AIF.od-g.txt"
...
saveRDS(gl_AIF.g, "analysis/gl_AIF.g.rds")
cat("R data saved")
