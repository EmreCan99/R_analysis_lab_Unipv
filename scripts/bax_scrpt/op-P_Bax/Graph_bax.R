...
plt <- ggplot(set_combined, aes(x = Group, y = Mean, fill = Group)) +
  ...
  labs(title = "Bax 1B, 7B, 11B", y = "Purkinje (OD)", x = "Condition") +
  theme_classic() +
...
ggsave(filename = "analysis/op_plt/bax_1A_7A_11A.png", plot = plt, 
       width = 12, height = 8, dpi = 300, units = "cm")

saveRDS(plt, file = "analysis/bax_1A_7A_11A.rds")


ggsave(filename = "analysis/op_plt/bax_1B_7B_11B.sig.png", plot = plt.sig, 
       width = 12, height = 8, dpi = 300, units = "cm")
