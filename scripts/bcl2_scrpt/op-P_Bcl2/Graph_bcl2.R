...
padding <- 8 # Add some padding above the maximum value STANDART 10
...
plt <- ggplot(set_combined, aes(x = Group, y = Mean, fill = Group)) +
  ...
  labs(title = "bcl2 1B, 7B, 11B", y = "Purkinje (OD)", x = "Condition") +
  theme_classic() +
...
ggsave(filename = "analysis/op_plt/bcl2_1B_7B_11B.png", plot = plt, 
