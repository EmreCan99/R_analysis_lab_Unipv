...
padding <- 0.002 # Add some padding above the maximum value STANDART 0
...
ggsave(filename = "analysis/bcl2_ip_1B_7B_11B.png", plot = plt, 
       width = 12, height = 8, dpi = 300, units = "cm")

saveRDS(plt, file = "analysis/bcl2_ip_1B_7B_11B.rds")
