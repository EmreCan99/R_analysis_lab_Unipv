...
gl_bcl2.g$Tukey[[group_title]] <- tukey_df

# Sink to the txt file

path <- "/Users/emrecanciftci/betik/R_projects/lab_data_unipv/analysis/bcl2.od-g.txt"
...
saveRDS(gl_bcl2.g, "analysis/gl_bcl2.g.rds")
cat("R data saved")
