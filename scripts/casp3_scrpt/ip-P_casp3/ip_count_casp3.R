...
# Sink
path <- "/Users/emrecanciftci/betik/R_projects/lab_data_unipv/analysis/casp3.ip-p.txt"
...
saveRDS(plot_data, file = "analysis/raw_rds/casp3_ip_1B_7B_11B_plot_data.p.rds")

saveRDS(data_sigx3, file = "analysis/raw_rds/casp3_ip_1B_7B_11B_data_sig.p.rds")
