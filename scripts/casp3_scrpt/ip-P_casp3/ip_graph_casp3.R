...
plt <- ggplot(plot_data, aes(x = Group, y = Mean, fill = Group)) +
  ...
  labs(title = "Casp3 1A, 7A, 11A", y = "Purkinje Cell Density", x = "Condition") +
  theme_classic() +
...
ggsave(filename = "analysis/ip_plt/casp3_ip_1A_7A_11a.png", plot = plt.sig, 
       width = 12, height = 8, dpi = 300, units = "cm")

saveRDS(plt, file = "analysis/casp3_ip_1A_7A_11A.rds")
