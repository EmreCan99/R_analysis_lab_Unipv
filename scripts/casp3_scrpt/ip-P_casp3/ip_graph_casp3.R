...
plt <- ggplot(plot_data, aes(x = Group, y = Mean, fill = Group)) +
  ...
  labs(title = "casp3 1B, 7B, 11B", y = "Purkinje Cell Density", x = "Condition") +
  theme_classic() +
...
ggsave(filename = "analysis/casp3_ip_1B_7B_11B.png", plot = plt, 
       width = 12, height = 8, dpi = 300, units = "cm")

saveRDS(plt, file = "analysis/casp3_ip_1B_7B_11B.rds")
